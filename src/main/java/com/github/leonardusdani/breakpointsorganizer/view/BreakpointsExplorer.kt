package com.github.leonardusdani.breakpointsorganizer.view

import com.github.leonardusdani.breakpointsorganizer.ext.convertToEntity
import com.github.leonardusdani.breakpointsorganizer.model.*
...
class BreakpointsExplorer(val project: Project) : SimpleToolWindowPanel(false, true), DataProvider, Disposable {
    ...
    init {
        myModel = DefaultTreeModel(DefaultMutableTreeNode("Breakpoint Organizer"))
